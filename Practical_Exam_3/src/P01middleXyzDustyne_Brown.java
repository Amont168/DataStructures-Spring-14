...
//==============================================================================
public class P01middleXyzDustyne_Brown                   // <--- YOUR NAME
{
  ...
  public static boolean xyzMiddle(String str)
  {
      ...
      if (lengthCheck >= 3)
      {
          if(length-.5 == length2)
          {
              if((int)str.charAt(length2) == 121)
              {
                  if((int)str.charAt(length2-1) == 120)
                  {
                      if((int)str.charAt(length2+1) == 122)
                      {
                          return true;
                      }
                  }
          ...
          {
              if((int)str.charAt(length2-1) == 121)
              {
                  if((int)str.charAt(length2-2) == 120)
                          {
                              if((int)str.charAt(length2) == 122)
                              {
                                  return true;
                              }
                          }
              }
              else if ((int) str.charAt(length2) == 121)
              {
                  if((int)str.charAt(length2-1) == 120)
                  {
                     if((int)str.charAt(length2+1) == 122)
